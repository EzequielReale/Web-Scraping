<template>
  <v-container fluid class="align-center justify-center" style="width: 100vh;">
    ...
    <v-form @submit.prevent="addWebsite">
      ...
      <v-text-field v-model.number="website.pageLevels" label="Niveles de página" required min="1" max="99"
...
export default {
  data() {
    return {
      ...
      frequencies: ['Diario', 'Semanal', 'Mensual'], // Opciones del desplegable de frecuencia
    };
  },
  methods: {
    addWebsite() {
